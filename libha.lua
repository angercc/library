...
local library = utility.table({theme = table.clone(themes.Default), folder = "Headshotme", extension = "json", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
    local themes = {"Default", "Midnight", "TokyoNight"}
